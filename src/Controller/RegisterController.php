    ...
    public function index(Request $request, UserPasswordHasherInterface $encoder): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if (!$search_email) {
                ...
                $mail = new Mail();
                $content = "Bonjour " . $user->getEmail() . "<br/>Bienvenue sur la première boutique dédiée au made in France.<br><br/>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam expedita fugiat ipsa magnam mollitia optio voluptas! Alias, aliquid dicta ducimus exercitationem facilis, incidunt magni, minus natus nihil odio quos sunt?";
                $mail->send($user->getEmail(), $user->getEmail(), 'Bienvenue sur La Boutique Française', $content);
